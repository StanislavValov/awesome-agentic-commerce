...
- [Market Intelligence API](https://api.marketintelligenceapi.com) - Pay-per-call market intelligence for trading agents from on-chain trade flow: buy/sell pressure, goal-driven opportunity scans with evidence and risk factors, perp positioning, smart-money wallets and rates, for crypto and tokenized US stocks. x402 on Base, Polygon, Arbitrum and Solana; [MCP server](https://registry.modelcontextprotocol.io/v0/servers?search=marketintelligenceapi) in the official registry.
